...
void CTrafficMonitorApp::LoadConfig()
{
    ...
    m_taskbar_data.avoid_overlap_with_taskbar_buttons = ini.GetBool(_T("task_bar"), _T("avoid_overlap_with_taskbar_buttons"), true);
...
void CTrafficMonitorApp::SaveConfig()
{
    ...
    ini.WriteBool(L"task_bar", L"avoid_overlap_with_taskbar_buttons", m_taskbar_data.avoid_overlap_with_taskbar_buttons);
